...
// (ResponsesParameters): a kind-discriminated oneOf over
// ResponsesPrepareSessionParameters and ResponsesModelStepParameters (both
// in schemaDefs above), frozen by revision 3.
const schemaParametersBody = `{"$schema":"https://json-schema.org/draft/2020-12/schema","oneOf":[{"$ref":"#/$defs/ResponsesPrepareSessionParameters"},{"$ref":"#/$defs/ResponsesModelStepParameters"}]}`

// schemaEvidenceBody is the zatiti.responses.evidence/v1 document schema
// (ResponsesEvidence). Revision 3 adds the required session_handle and
// makes response_id/output/output_artifacts optional: a prepare_session
// evidence document carries only the session handle it minted, never a
// model output.
const schemaEvidenceBody = `{"$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"output":{"$ref":"#/$defs/ModelOutput"},"output_artifacts":{"items":{"$ref":"#/$defs/ArtifactRef"},"maxItems":256,"minItems":0,"type":"array"},"physical_call":{"$ref":"#/$defs/PhysicalCallEvidence"},"response_id":{"maxLength":1024,"minLength":0,"type":"string"},"schema":{"const":"zatiti.responses.evidence/v1","type":"string"},"session_handle":{"maxLength":1024,"minLength":1,"type":"string"},"staged_outputs":{"items":{"$ref":"#/$defs/StagedOutput"},"maxItems":256,"minItems":0,"type":"array"}},"required":["schema","physical_call","session_handle","staged_outputs"],"type":"object"}`
