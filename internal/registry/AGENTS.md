...
Own typed operation registration, collision checks, discovery, schema/OpenAPI generation and parity enumeration.

Write scope: **`internal/registry/` only**, excluding this generated AGENTS.md. Go package name: `registry`. Ownership kind: infrastructure; integration wave: 1.
...
Local proving focus: All operation mappings/schema conformance, collision rejection, internal visibility, deterministic OpenAPI and self-discovery, DTO validation consistency.
