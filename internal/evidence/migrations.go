...
// finished by _evidence.command.finish; the unique index is what makes a
// fresh begin() and a replaying begin() distinguishable, and the finished
// fence (a disposition count, see commandRow) is what admits one replacement
// of an accepted pending disposition and no other second finish().
const schemaV1 = `
