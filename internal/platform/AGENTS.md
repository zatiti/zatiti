...
Local proving focus: Competing process lock, permissions, interrupted stage/publish, encrypted roundtrip/tamper, symlink escape, unavailable key store, redacted errors, disk-pressure refusal, secret absence from child environment.
