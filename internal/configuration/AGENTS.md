...
Incoming callers: accounting, application, configuration, connections, effects, execution, installation, memory, messaging, policy, reviews, scheduling, skills, tasks, application (authenticated public operations).
