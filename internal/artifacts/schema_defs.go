...
//
// Revision 3 (internal/artifacts/AGENTS.md "Local schema definitions"):
// Artifact gains optional source_operation_id/purpose (provenance); Operation
// gains optional attempts/callback_route alongside new CallbackRoute and
// OperationAttempt defs. These new fields are additive and optional: no
// artifacts operation currently references OperationAttempt/CallbackRoute
// directly, and TestDescriptorsMatchFrozenCatalog compares each operation's
// own schema body with $defs stripped, so this sync only widens what the
// shared catalog document declares.
