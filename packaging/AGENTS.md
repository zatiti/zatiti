...
Write scope: **`packaging/` only**, excluding this generated AGENTS.md. Go package name: `not a Go package`. Ownership kind: support; integration wave: 4.
...
Clean native arm64 and amd64 macOS install/first-chat/launch/upgrade/restart/uninstall preserve state, secure permissions, controller survives desktop close, Serenity lifecycle and license notice audit; Linux requires later separate qualification.
